...
<link rel="stylesheet" type="text/css" href="css/l_sign.css"/>
<title>Landowner Registration</title>
</head>
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5">
				...
				<hr>
			<form action="l_reg.jsp" onsubmit="return validateForm()" method="post">
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-10">
						<input type="text" class="form-control" name="l_stat" placeholder="Land status" required>
					</div>
				</div>
